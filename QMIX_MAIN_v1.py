...
if __name__ == '__main__':
    ...
    parser.add_argument("--max_steps", type=int, default=int(40), help=" Maximum number of training steps")
    ...
    parser.add_argument("--uav_move_radius", type=int, default=1, help="The radius of the movement of the uav")
